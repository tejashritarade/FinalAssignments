...
public class Assignment2 {
	...
	public static void main(String[] args) throws InterruptedException
	{
		...
		boolean s1 = driver.findElement(By.xpath("//span[normalize-space()='Videos']")).isDisplayed();

		System.out.println("Videos--"+s1);

		boolean s2 = driver.findElement(By.xpath("//span[normalize-space()='News']")).isDisplayed();

		System.out.println("News--"+s2);

		boolean s3 = driver.findElement(By.xpath("//span[@class='st-text'][normalize-space()='Technology']"))
				.isDisplayed();
		...
		String s7 = driver
				.findElement(By
						.xpath("//body/div[@id='indiatimes_app_id']/div[1]/div[1]/footer[1]/div[1]/div[2]/div[7]/a[4]"))
				.getAttribute("href");
		...
		WebElement human =driver.findElement(By.xpath("//body/div[@id='indiatimes_app_id']/div[1]/div[1]/div[1]/div[2]/ul[1]/li[7]/div[1]/ul[1]/li[1]/div[1]/div[1]/a[1]"));
